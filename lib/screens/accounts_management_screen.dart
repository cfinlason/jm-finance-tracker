          ...
          children: [
            Row(
              ...
              children: [
                ...
                IconButton(icon: const Icon(LucideIcons.plus, color: AppColors.accent), onPressed: () => showDialog(context: context, builder: (_) => const AccountEditDialog(id: 'new'))),
              ],
            ),
            if (accounts.isEmpty)
              EmptyState(
                ...
                onPressCta: () => showDialog(context: context, builder: (_) => const AccountEditDialog(id: 'new')),
              )
            else
              AppCard(
                child: Column(
